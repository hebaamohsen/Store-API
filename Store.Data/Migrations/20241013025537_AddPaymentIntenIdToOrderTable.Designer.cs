...
namespace Store.Data.Migrations
{
    ...
    [Migration("20241013025537_AddPaymentIntenIdToOrderTable")]
    partial class AddPaymentIntenIdToOrderTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderEntities.OrderItem", b =>
                {
                    ...
                    b.Property<int>("productItemProductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("productItemProductId");

                    b.ToTable("OrderItem");
                });

            modelBuilder.Entity("Store.Data.Entities.OrderEntities.ProductItem", b =>
                {
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderEntities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Store.Data.Entities.OrderEntities.ProductItem", "productItem")
                        .WithMany()
                        .HasForeignKey("productItemProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
